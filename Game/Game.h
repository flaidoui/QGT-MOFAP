...
class Game
{
   ...
   //--------------ajouté le 15-5-2019
    ...
    void GameEvaluationParetoUneSolNash(string instance,const int max_gen,vector<Individual*> solutionSs,double start, double & elapsed_secs,int & indexNASHEbest, vector <double> & NASHEJ, double & HVValue);
