                  ...
                  nondominancescore = 0 ;// pour compter le nombre de solution qui domine la solution courante
                   ...
                   for( j = 0; j < trx.AvailableFrequencies->size() ;j++)
                   {
                       ...
                       if (i!=j)
                       {
                                   ...
                                   if (paircost[i].first <= paircost[j].first)  // on teste la dominance par rapport au deuciÃƒÂ¨me objectif
                                    {
                                          if (paircost[i].second < paircost[j].second)
                                  ...
                                  /* else
                                    {
                                         if (paircost[i].second <= paircost[j].second) // teste la dominance par rapport au deuciÃƒÂ¨me objectif
                                        {
...
//--------------------- dominance available
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   case  551://strategy 5 choisir la meilleur fréquence en terme Front parteo pure Minimum ecart
    {
          int i,indexmin,j,k;
       // Individual * tempsol =  new Individual();
        int tempfreq;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ FRONt PARETO PUUUUUUUUUUUURE Plus grand HV ~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   case  552://strategy 5 choisir la meilleur fréquence en terme Front parteo pure plus grand HV
    {
          int i,indexmin,j,k;
       // Individual * tempsol =  new Individual();
        int tempfreq;
...
//--------------------- dominance available
    ...
    //------------------------------------------------------------------------------
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ FRONt PARETO ~~~~~~~~~~~~~~~~~~~~~~
      case  53 ://strategy 5 choisir la meilleur fréquence en terme Front parteo
    {
          int i,indexmin,j,k;
       // Individual * tempsol =  new Individual();
        int tempfreq;
...
//--------------------- dominance available
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ FRONt PARETO ~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     case  500 ://strategy 5 choisir la meilleur fréquence en terme Front parteo egoiste aléatoire
    {
        int i,indexmin,j,k;
       // Individual * tempsol =  new Individual();
        int tempfreq;
...
//--------------------- dominance available
    ...
    break;
    }//case 500  : best frequency Front pareto egoiste aléatoire
    //------------------------------------------------------------------------------
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ FRONt PARETO ~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 //--------------------------------------------------
 case  501 ://strategy 5 choisir la meilleur fréquence en terme Front parteo inspiré . si plusieurs fréquence
      ...
      //je supose que la soluution est domiinée et je vais tester si c est vrai
           ...
           //++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            sort(distance.begin(),distance.end(),my_cmpInfDoublePair);
                ...
                indexmin = distance.front().first;// récupération de l'indice de la fréquence
              }
               else// il n y a aucune valeur dans le front pareto
                {
                        cout << " taille 0000000000000000 " << endl;
